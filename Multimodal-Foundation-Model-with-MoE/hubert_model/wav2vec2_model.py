...
# This file was copied from the s3prl package:
#  - https://github.com/s3prl/s3prl/blob/main/s3prl/upstream/wav2vec2/wav2vec2_model.py
        ...
        **kwargs,
        ...
        if retain_dropout:
            if retain_dropout_modules is not None and self.module_name is None:
                ...
                _logger.info("Disabling dropout for module: {}".format(name))
